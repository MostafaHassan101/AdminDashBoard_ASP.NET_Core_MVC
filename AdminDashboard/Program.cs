...
var connectionString = builder.Configuration.GetConnectionString("DbConnectionStringMakarios") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
